...
function Device(adapter, connection, gpsServer) {
 ...
 //console.log('llege aqui');
  ...
  this.on('error', function (err) {
	  _this.do_log('Something not working');
	  _this.do_log(err.stack);
  });  
   
  this.on('data', function (data) {
	  console.log('\n\n\n\n\nthen', data.toString('hex'))
    ...
    if (this.getUID() === false) {
      console.log("msgParts.device_id " +msgParts.device_id);
      this.setUID(msgParts.device_id.substr(1, 16));
    }
